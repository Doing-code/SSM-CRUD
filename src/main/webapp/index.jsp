...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            ...
            <button class="btn btn-danger" id="emp_ddelete_all_btn">删除</button>
        </div>
    </div>
    <%--        显示表格数据--%>
    <div class="row">
...
<script type="text/javascript">
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            var editBtn = $("<button></button>").addClass("btn btn-primary btn-sm edit_btn")
                .append($("<span></span>").addClass("glyphicon glyphicon-pencil")).append(" 编 辑");
            //为编辑按钮添加自定义的属性，来表示当前员工的id
            editBtn.attr("edit-id",item.empId);
            var delBtn = $("<button></button>").addClass("btn btn-danger btn-sm delete_btn")
                .append($("<span></span>").addClass("glyphicon glyphicon-trash")).append(" 删 除");
            //为删除按钮添加一个自定义属性，来表示当前员工删除的id
    ...
    function validate_add_form() {
        ...
        if (!regName.test(empName)) {
            // alert("用户名可以是2-5位中文或者6-16英文和数字的组合");
            show_validate_msg("#empName_add_input", "error", "用户名可以是2-5位中文或者6-16英文和数字的组合");
            return false;
        } else {
    ...
    //点击全部删除，执行批量删除
    $("#emp_ddelete_all_btn").click(function () {
        // $(".check_item:checked")
        var empNames = "";
        var del_idstr = "";
